...
public class ge_montx_to_p3 {
    ...
    static int ge_montx_to_p3(ge_p3 p, int[] u, int ed_sign_bit)
    {
        ...
        fe_1.fe_1(one);
        fe_sq.fe_sq(x2, p.X);                /* x^2 */
        fe_sq.fe_sq(y2, p.Y);                /* y^2 */

        fe_mul.fe_mul(dx2y2, x2, y2);           /* x^2y^2 */
        fe_mul.fe_mul(dx2y2, dx2y2, d);         /* dx^2y^2 */
        fe_add.fe_add(dx2y2, dx2y2, one);       /* dx^2y^2 + 1 */

        fe_neg.fe_neg(x2y2, x2);                /* -x^2 */
        fe_add.fe_add(x2y2, x2y2, y2);          /* -x^2 + y^2 */
