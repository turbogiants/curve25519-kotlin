...
import static org.creativeturbogiants.crypto.java.ge_p3_to_cached.ge_p3_to_cached;
...
public class ge_scalarmult {
    ...
    static void cmov_p3(ge_p3 t, ge_p3 u, int b){
        fe_cmov.fe_cmov(t.X, u.X, b);
        fe_cmov.fe_cmov(t.Y, u.Y, b);
        fe_cmov.fe_cmov(t.Z, u.Z, b);
        fe_cmov.fe_cmov(t.T, u.T, b);
    }
    ...
    public static void ge_scalarmult(ge_p3 h, byte[] a, ge_p3 A){
        ...
        fe_copy.fe_copy(p.T, A.T);
        fe_copy.fe_copy(p.X, A.X);
        fe_copy.fe_copy(p.Y, A.Y);
        fe_copy.fe_copy(p.Z, A.Z);
        ...
        for (int i=0; i<256; i++){
            ...
            // ge add
            ge_p3_to_cached(c, q);
            ge_add.ge_add(t0, p, c);
            ge_p1p1_to_p3.ge_p1p1_to_p3(t, t0);
            ...
            ge_p3_dbl.ge_p3_dbl(p1, p);
            ge_p1p1_to_p3.ge_p1p1_to_p3(p, p1);
        }
        fe_copy.fe_copy(h.X, q.X);
        fe_copy.fe_copy(h.Y, q.Y);
        fe_copy.fe_copy(h.Z, q.Z);
        fe_copy.fe_copy(h.T, q.T);
    }
}
